...
public class Fenster extends JFrame {
	...
	// Menü Punkte
	final JMenuItem miNew, miOpen, miSaveAs, miExit;
	...
	public final static String ACTION_OPEN = "OPEN", ACTION_SAVEAS = "SAVEAS", ACTION_EXIT = "EXIT", ACTION_NEW = "NEW";
	public Fenster() {
		// Titel für das Fenster.
		super("Editor mit Swing");
		setSize(400, 300);

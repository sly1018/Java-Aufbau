...
public class Handler implements DocumentListener {
	...
	public void onOpen(ActionEvent evt) {
		...
		if (selFile != null) {
			...
			// Dateiname an der Titelleiste anzeigen
			File f = new File(selFile);
			fenster.setTitle(f.getName());
	...
	public void onSave(ActionEvent evt) {
		...
		if (fenster.getTitle().isEmpty())
			speichernAbfragen();
		else
			inFileSpeichern(fenster.getTitle(), fenster.txtArea.getText());
